...
case "$(python --version 2>&1)" in
    *" 2."*)
        python -c 'import urllib; urllib.urlretrieve ("https://github.com/GATB/gatb-core/archive/v1.4.2.tar.gz", "gatbcore.tar.gz")'
        ;;
	*" 3."*)
		python -c 'import urllib.request; urllib.request.urlretrieve ("https://github.com/GATB/gatb-core/archive/v1.4.2.tar.gz", "gatbcore.tar.gz")'
	;;
    *)
