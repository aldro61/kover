...
class BreimanInfo(object):
    def __init__(self, node_n_examples_by_class, class_priors, total_n_examples_by_class):
        ...
        self.p_j_t = {
            c: class_priors[c] * node_n_examples_by_class[c] / total_n_examples_by_class[c] for c in class_priors.keys()
        }
...
class TreeNode(BaseModel):
    ...
    def __init__(
        ...
        self.breiman_info = BreimanInfo(
            node_n_examples_by_class=n_examples_by_class,
